              ...
              <div className="flex flex-col lg:flex-row p-6">
                <div className="lg:w-1/2 flex items-center justify-center">
                  <div className="relative w-full h-[300px] lg:h-[400px] rounded-xl overflow-hidden">
                    <Image
                      src="https://res.cloudinary.com/deeyw3apd/image/upload/v1742199506/cat-campaign_j3fgva.jpg"
                ...
                <div className="lg:w-1/2 flex flex-col justify-center lg:pl-8 mt-6 lg:mt-0">
                  ...
                  <p className="text-xl mb-6 text-amber-900">
                  ...
                  <p className="text-lg mb-8 text-amber-900">
